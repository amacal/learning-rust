...
mod tests {
    ...
    fn handles_closing_nfa_from_epsilon_state() {
        ...
        workbench.worklist_items_add(worklist, 0);
        ...
        assert_eq!(workbench.closures_items_get(closure, 0), 3);
        assert_eq!(workbench.closures_items_get(closure, 1), 10);
    ...
    fn handles_converting_nfa_to_dfa_optional() {
        ...
        // 0000 | 73 - 73 | 0002 | 0000
        // 0001 | 70 - 70 | 0003 | 0001
